...
<body>
    ...
    <div id="pc" class="opcionesmovil">
        <div id="pc" class="opcionespc">
            <div onclick="manejarOpciones('moal'); ocultarEnviar()">
                <img id="alien" class="opcion2" src="src/ordenadores/alienware.jpg" alt="">
            </div>
            <div onclick="manejarOpciones('ms'); ocultarEnviar()">
                <img id="samsung" class="opcion2" src="src/samsumg.png" alt="">
            </div>
            <div onclick="manejarOpciones('mh'); ocultarEnviar()">
                <img id="huawei" class="opcion2" src="src/Huawei.png" alt="">
            </div>
            <div onclick="manejarOpciones('mx'); ocultarEnviar()">
                <img id="xiaomi" class="opcion2" src="src/xiaomi.png" alt="">
            </div>
            <div onclick="manejarOpciones('msy'); ocultarEnviar()">
                <img id="sony" class="opcion2" src="src/sony.png" alt="">
            </div>
            <div onclick="manejarOpciones('mo'); ocultarEnviar()">
                <img id="oppo" class="opcion2" src="src/oppo.png" alt="">
            </div>
        </div>
